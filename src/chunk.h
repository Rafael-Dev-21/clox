...
typedef enum {
  ...
  OP_NIL,      /**< Is a nil value. */
  OP_TRUE,     /**< Is a true value. */
  OP_FALSE,    /**< Is a false value. */
  OP_EQUAL,    /**< Tests equality. */
  OP_GREATER,  /**< Tests greater than. */
  OP_LESS,     /**< Tests less than. */
...
/**
 * A function that init a empty Chunk with null {@link Chunk#code } and 0 (zero)
 * {@link Chunk#capacity } and {@link Chunk#count}.
 *
